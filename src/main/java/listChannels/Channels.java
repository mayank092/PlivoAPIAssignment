...
import response.Purpose;
import response.Topic;
...
public class Channels {
    ...
    @JsonProperty("is_general")
    public void setIs_General(Boolean is_general) { this.is_general = is_general; }
    @JsonProperty("is_shared")
    public Boolean getIs_Shared() { return is_shared; }
    @JsonProperty("is_shared")
    public void setIs_Shared(Boolean is_shared) { this.is_shared = is_shared; }
    @JsonProperty("is_org_shared")
    public Boolean getIs_Org_Shared() { return is_org_shared; }
    @JsonProperty("is_org_shared")
    public void setIs_org_Shared(Boolean is_org_shared) { this.is_org_shared = is_org_shared; }
    @JsonProperty("is_member")
    ...
    @JsonProperty("num_members")
    public void setNumMembers (Integer num_members)
    {
